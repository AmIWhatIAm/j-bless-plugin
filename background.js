...
// Temporary test extractor. Production extraction can replace this function
// while keeping the same `extractedJob` output shape.
function extractJobFromPage() {
  ...
  return {
    ...
    jobDescription: text(jsonLd?.description || content('meta[name="description"]') || firstText([
      '[data-job-description]', '.job-description', '#job-description', '[class*="description"]', 'main'
    ])),
